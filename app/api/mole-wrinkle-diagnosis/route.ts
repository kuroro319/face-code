...
【解釈ルール】
・ほくろ：1つずつ個別に解釈してください。
・シワの表記が「〜のシワ」→ 1本のシワです。その1本が持つ具体的な意味を個別に解釈してください。
・シワの表記が「〜にN本のシワ」→ N本をまとめて1つの解釈を生成してください。本数・位置の傾向から総合的な運勢・性格を読み取ってください。

各項目について1エントリを生成し、JSON配列形式のみで回答してください（他のテキストは不要）：
[
  {
    "type": "mole",
    "location": "位置名（例：右頬）",
