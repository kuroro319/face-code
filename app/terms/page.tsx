          ...
          <div className="space-y-10" style={{ color: "#2D2D2D" }}>
            ...
            <section>
              ...
              <div className="leading-relaxed space-y-3" style={{ color: "#555" }}>
                ...
                <p className="font-bold" style={{ color: "#2D2D2D" }}>
                  18歳未満の第三者が写っている写真のアップロードは、本人・保護者の同意の有無にかかわらず禁止します。
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-2" style={{ color: "#555" }}>
                {[
                  ...
                  "第三者の顔写真を本人の同意なくアップロードする行為",
                  "18歳未満の第三者が写っている写真をアップロードする行為",  // ← 追加
                  "診断結果を用いて他者を誹謗中傷・いじめ・ハラスメント・差別目的で使用する行為",  // ← 強化
                  "診断結果をSNS等で拡散し、特定の個人の名誉・プライバシーを侵害する行為",  // ← 追加
                  "その他、運営者が不適切と判断する行為",
                ].map((item, i) => (
            ...
            <section>
              ...
              <div className="leading-relaxed space-y-3" style={{ color: "#555" }}>
                ...
                <p>
                  運営者は、本サービスに起因してユーザーに生じたあらゆる損害について一切の責任を負いません（運営者の故意または重過失による場合を除きます）。
                </p>
                {/* ← 追加 */}
                <div
                  className="rounded-xl p-4 mt-2"
                  style={{ backgroundColor: "rgba(232, 160, 160, 0.08)", border: "1px solid rgba(232, 160, 160, 0.3)" }}
                >
                  <p className="font-bold mb-2" style={{ color: "#2D2D2D" }}>
                    ⚠️ ユーザーの行為に起因する免責
                  </p>
                  <p>
                    ユーザーが診断結果を第三者へのいじめ・誹謗中傷・ハラスメント・差別目的で使用したことにより生じた損害（精神的損害・名誉毀損・プライバシー侵害等を含む）について、運営者は一切の責任を負いません。
                  </p>
                  <p className="mt-2">
                    また、ユーザーが第三者の顔写真を本人の同意なくアップロードしたことにより生じた損害・トラブルについても、運営者は責任を負わず、当該ユーザーが自己の責任において解決するものとします。
                  </p>
                </div>
              </div>
            </section>
